package android.vinicius.loginmvc.controller;

import android.content.ContentValues;
import android.content.Context;
import android.vinicius.loginmvc.datamodel.UsuarioDataModel;
import android.vinicius.loginmvc.datasource.AppDataBase;
...
public class UsuarioController extends AppDataBase implements iCrud<Usuario> {
    ...
    public  boolean usuarioSenha(String username, String senha) {
        return checkUserPassword(username, senha);
    }
